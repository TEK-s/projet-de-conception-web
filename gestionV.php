...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">ajout d'un Vaisseaux</h5>
      ...
      <div class="modal-body">
        <form class="needs-validation"  class="inscription-form text-center" method="POST" enctype="multipart/form-data">
                ...
                <button type="submit" name="ajoutV" id="ajoutV" class="btn btn-primary">Save changes</button>
</form>
      </div>
  ...
  <tbody>
      <?php 
             ...
             $controle1 = $db->prepare("SELECT * FROM vaisseaux");
             $controle1->execute([]);
...
<tr>
      ...
      <td>
          <form method="POST" action="gestionV_M.php">
              <input type="hidden" name="modifierV_id" id="modifierV_id"  value="<?php echo $resultat1['id'];?>">
          <button type="submit" name="modifierV" class="btn btn-primary">
             modifier
      </button>
             </form>
    </td>
      <td>
      <form method="POST" action="supprimerV.php">
              <input type="hidden" name="supprimerV_id" id="supprimerV_id"  value="<?php echo $resultat1['id'];?>">
    <button type="submit" class="btn btn-primary" name="supprimerV">
    supprimer 
    </button></td>
    </form>
    </tr>

                 ...
                 <?php echo'<img src="image/'.$resultat1['image'].'" class="container-fluid  ">'?>
                  ...
                  <div class="col-md-8 col-sm-8 my-5 container ">
                        ...
                        <div class="card border-dark mb-4" style="width: 100%;">
                            <div class="card-header text-center">Caractéristques du film</div>
                            <div class="card-body text-dark">
                                <p class="card-text"><span style="font-weight: bold;">Auteur:</span> <?php echo $resultat1['auteur'];?></p>
                          <p class="card-text"><span style="font-weight: bold;">date de réalisation:</span><?php echo $resultat1['date_rel'];?></p>
